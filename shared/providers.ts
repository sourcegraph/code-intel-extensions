                ...
                for await (const lspResult of lspProvider(textDocument, position)) {
                    if (lspResult) {
                        ...
                        lspResult.alerts = [{
                            ...
                            badge: {
                                kind: 'info',
                                hoverMessage: 'This hover text comes from a language server running in the cloud. These servers are resource intensive, and you can improve the reliability of this result by enabling semantic indexing. Click to learn how!',
                                linkURL: 'https://docs.sourcegraph.com/user/code_intelligence/lsif'
                            },
                            dismissible: false
                        }]
                ...
                if (searchResult) {
                    ...
                    yield {
                        ...
                        alerts: [{
                            ...
                            badge: {
                                kind: 'info',
                                hoverMessage: 'This hover text is generated by a heuristic text based search, so it might be inaccurate. You can improve these results by enabling semantic indexing for this project. Click to learn how!',
                                linkURL: 'https://docs.sourcegraph.com/user/code_intelligence/lsif',
                            },
                            dismissible: false,
                        }]
