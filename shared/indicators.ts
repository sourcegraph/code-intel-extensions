...
// TODO - remove once package is updated
...
export const partialDefinitionNoHoverBadge: AggregableBadge = {
    text: 'partial semantic',
    linkURL,
    hoverMessage:
...
const makeAlert = ({
    ...
    const badge = { kind: 'info', linkURL, hoverMessage }
    const text = `${message} [Learn more about precise code intelligence](${linkURL})`
    const summary = { kind: sourcegraph.MarkupKind.Markdown, value: text }
    return { type, iconKind: 'info', summary, badge } as any
}
